      ...
      <div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
        ...
        <div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
          <div class="d-flex flex-center flex-lg-start flex-column">
            ...
            <h2 class="fw-normal mt-5 mb-5" style="margin:0 auto;">OTP Update</h2>
            <!--end::Title-->
          </div>
          <!--begin::Form-->
          <form action="{{ route('password.verify.otp') }}" method="POST">
            ...
            <div>
                ...
                <input type="text" name="otp_code" class="form-control mt-2 mb-5" required>
            </div>
            <button type="submit" class="custombutton">Verify OTP</button>
        </form>
