              ...
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card">
                  ...
                  <div class="card-body py-4">
                    ...
                    <h3>Devotees of <strong>{{$show->title}}</strong> Skill</h2>


                    @if($devoteeskills->count() != NULL)
                    <div class="table-responsive">
                        ...
                        <tbody>
                          @php $i = 1; @endphp
                          @foreach($devoteeskills as $list)
                          <tr>
                            <td>@php echo $i; @endphp</td>
                            <td><a href="{{ route('devotees.show', $list->devotee_id)}}">
                              @if(Helper::getdevoteebyid($list->devotee_id)->firstname != NULL){{Crypt::decrypt(Helper::getdevoteebyid($list->devotee_id)->firstname)}}@endif
                              @if(Helper::getdevoteebyid($list->devotee_id)->middlename != NULL){{Crypt::decrypt(Helper::getdevoteebyid($list->devotee_id)->middlename)}}@endif
                              @if(Helper::getdevoteebyid($list->devotee_id)->surname != NULL){{Crypt::decrypt(Helper::getdevoteebyid($list->devotee_id)->surname)}}@endif
                            </a></td>
                            <td>
                              {{Helper::getbranchbydevotee($list->devotee_id)->title}}
                            </td>
                            <td class="text-end">
