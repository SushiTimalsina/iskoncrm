        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Skills Management</h1>
              <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                  <a href="{{route('skills.index')}}" class="text-muted text-hover-primary">Skills Management</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="d-flex flex-column flex-column-fluid">
            <div id="kt_app_content" class="app-content flex-column-fluid">
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <form method="get" action="{{route('skillssearch')}}" enctype="multipart/form-data">
                  <!--begin::Card-->
                  <div class="card mb-7">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-center">
                        ...
                        <div class="position-relative w-md-600px me-md-2">
                          ...
                          <input class="form-control ps-10" value="" placeholder="Search Skills" id="search" name="search" @if(isset($_GET['search'])) value="{{$_GET['search']}}" @endif  autocomplete="off" required  />
                        </div>
                        <!--end::Input group-->
                        <!--begin:Action-->
                  ...
                  <div class="card-header border-0 pt-6">
                    <div class="card-toolbar">
                      <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <i class="ki-outline ki-plus fs-2"></i>Add Skill</button>
                        @if (Route::currentRouteName() == 'skilltrash')
                        <a href="{{route('skills.index')}}" type="button" class="btn btn-primary ms-2">
                        <i class="ki-outline ki-file fs-2"></i>All Lists</a>
                        @else
                        <a href="{{route('skilltrash')}}" type="button" class="btn btn-primary ms-2">
                                  ...
                                  <div class="row">
                                      <div class="col-md-12 col-sm-12 col-lg-12 mb-2">
                                          <div class="form-group">
                                              <label for="catname">Skill Name</label>
                  ...
                  <div class="card-body py-4">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{$i}}</td>
                            <td><a href="{{ route('skills.show', $list->id)}}">{{$list->title}}</a></td>
                            <td>
                              @php
                              $getdevotees = \App\Models\DevoteeSkills::where('skill_id', $list->id)->get();
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="{{ route('skillrestore', $list->id)}}" class="btn btn-light d-block"><i class="ki-outline ki-arrows-loop fs-2"></i> Restore</a>
                                </div>
                                <div class="menu-item px-3">
                                  <form action="{{ route('skills.destroy', $list->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                ...
                                @can('skills-edit')
                                <div class="menu-item px-3">
                                  <a href="{{ route('skills.edit', $list->id)}}" class="btn btn-light d-block"><i class="ki-outline ki-pencil fs-2"></i> Edit</a>
                                </div>
                                @endcan
                                @can('skills-delete')
                                <div class="menu-item px-3">
                                  <a href="{{ route('skillmovetotrash', $list->id)}}" class="btn btn-light d-block"><i class="ki-outline ki-trash fs-2"></i> Trash</a>
                                </div>
                                @endcan
                                @endif
                              </div>
                          ...
                          @if(count($list->subcategory))
                            @include('backend.skills.subCategoryList',['subcategories' => $list->subcategory])
                          @endif
                          <?php $i++; ?>
                          @endforeach
                        </tbody>
