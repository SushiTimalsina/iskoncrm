        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Edit Course Attendance</h1>
              ...
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card">
                  ...
                  <div class="card-body py-4">
                    ...
                    <form method="post" action="{{ route('course-attend.update', $edit->id ) }}" enctype="multipart/form-data">
          						@csrf
          						@method('PATCH')
                      <div class="card-body">
                        <div class="row mb-2">
                          <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                              <div class="form-group">
                                  ...
                                  <select class="form-control" name="devotee" id="devotee" data-control="select2" required>
                                    <option value="">Select One</option>
                                    @if($devotees->count() != NULL)
                                      @foreach($devotees as $devotee)
                                        <option value="{{$devotee->id}}" {{ $edit->devotee_id == $devotee->id ? 'selected' : '' }}>{{$devotee->firstname}} {{$devotee->middlename}} {{$devotee->surname}}</option>
                                      @endforeach
                                    @endif
                                  </select>
                              </div>
                                ...
                                <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-select-sm" data-control="select2" name="status" id="status" required>
                                          ...
                                          <option value="Droped" {{ $edit->status == 'Droped' ? 'selected' : '' }}>Droped</option>
                          ...
                          <div class="row mb-2">
                            <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="fromdate" id="fromdate" value="{{$edit->fromdate}}">
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                  <div class="form-group">
                                      <label for="todate">To Date</label>
                                      <input type="text" class="form-control" name="todate" id="todate" value="{{$edit->todate}}">
                                  </div>
                                </div>
                                <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                    <div class="form-group">
                                        <label for="attendmarks">Attend Marks</label>
                                        <input type="number" class="form-control" name="attendmarks" id="attendmarks" value="{{$edit->attendmarks}}">
                                    </div>
                                  </div>
                            </div>
                          <div class="row mb-2">
