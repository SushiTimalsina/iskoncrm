              ...
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card">
                  ...
                  <div class="card-body py-4">
                    ...
                    @if (isset($edit))
                        <form action="{{ route('guest-take-care.update', $edit->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                    @else
                        <form action="{{ route('guest-take-care.store') }}" method="POST" enctype="multipart/form-data">
                    @endif
                      @csrf
                        <div class="row">
                          @if(!isset($edit))
                          ...
                          <div class="col-md-4 col-sm-4 col-lg-4 mb-2">
                            ...
                            <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                <button type="submit" class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">@if (isset($edit)) Update @else Create @endif Guest Take Care</button>
                            </div>
                          </div>
                    </form>
                  </div>
