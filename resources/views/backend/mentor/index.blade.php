        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Mentor Management</h1>
          ...
          <div class="d-flex flex-column flex-column-fluid">
            <div id="kt_app_content" class="app-content flex-column-fluid">
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <form method="get" action="{{route('mentorsearch')}}" enctype="multipart/form-data">
                  <!--begin::Card-->
                  <div class="card mb-7">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-center">
                          ...
                          <select class="form-select" data-control="select2" name="mentor" id="mentor">
                             ...
                             @if ($mentors->count() != null)
                               @foreach ($mentors as $mentor)
                                <option value="{{ $mentor->devotee_id }}" @if(isset($_GET['mentor']) && ($_GET['mentor'] == $mentor->devotee_id)) selected @endif>
                                  @if(Helper::getdevoteebymentor($mentor->id)->firstname != NULL){{Crypt::decrypt(Helper::getdevoteebymentor($mentor->id)->firstname)}}@endif
                                  @if(Helper::getdevoteebymentor($mentor->id)->middlename != NULL){{Crypt::decrypt(Helper::getdevoteebymentor($mentor->id)->middlename)}}@endif
                                  @if(Helper::getdevoteebymentor($mentor->id)->surname != NULL){{Crypt::decrypt(Helper::getdevoteebymentor($mentor->id)->surname)}}@endif
                                </option>
                               @endforeach
                             @endif
                          </select>
                        ...
                        <div class="d-flex align-items-center me-2">
                          <button type="submit" class="btn btn-primary me-5">Search</button>  <a href="{{route('mentor.index')}}" class="btn btn-primary me-5">Reset</a>
                        </div>
                  ...
                  <div class="card-header border-0 pt-6">
                    <div class="card-toolbar">
                      <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <i class="ki-outline ki-plus fs-2"></i>Add Mentor</a>
                        @if (Route::currentRouteName() == 'mentortrash')
                        <a href="{{route('mentor.index')}}" type="button" class="btn btn-primary ms-2">
                        <i class="ki-outline ki-file fs-2"></i>All Lists</a>
                        @else
                        <a href="{{route('mentortrash')}}" type="button" class="btn btn-primary ms-2">
                  ...
                  <div class="card-body py-4">
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{$i}}</td>
                            <td><a href="{{ route('mentor.show', $list->id)}}">
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="{{ route('mentorrestore', $list->id)}}" class="btn btn-light d-block"><i class="ki-outline ki-arrows-loop fs-2"></i> Restore</a>
                                </div>
                                <div class="menu-item px-3">
                                  <form action="{{ route('mentor.destroy', $list->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
                                ...
                                @else
                                  @can('mentor-list')
                                  <div class="menu-item px-3">
                                    <a href="{{route('mentor.show', $list->id)}}" class="btn btn-light d-block"><i class="ki-outline ki-eye fs-2"></i> View</a>
                                  </div>
                                  @endcan
                                  @can('mentor-edit')
                                  <div class="menu-item px-3">
                                    <a href="{{route('mentor.edit', $list->id)}}" class="btn btn-light d-block"><i class="ki-outline ki-pencil fs-2"></i> Edit</a>
                                  </div>
                                  @endcan
                                  @can('mentor-delete')
                                  <div class="menu-item px-3">
                                    <a href="{{route('mentormovetotrash', $list->id)}}" class="btn btn-light d-block"><i class="ki-outline ki-trash fs-2"></i> Trash</a>
                                  </div>
                                  @endcan
                                @endif
                              </div>
