        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Edit Donation</h1>
              ...
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card">
                  ...
                  <div class="card-body py-4">
                    ...
                    <form method="post" action="{{ route('donation.update', $edit->id ) }}" enctype="multipart/form-data">
          						@csrf
          						@method('PATCH')
                      <div class="card-body">
                          ...
                          <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                  ...
                                  <select class="form-control" name="devotee" id="devotee" required>
                                    ...
                                    @if($devotees->count() != NULL)
                                      @foreach($devotees as $devotee)
                                          <option value="{{$devotee->id}}"  {{ $edit->devotee_id == $devotee->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" data-control="select2" name="branch" id="branch" required>
                                      <option value="">Select One</option>
                                      ...
                                      <select class="form-select" data-control="select2" name="sewa" id="sewa" required>
                                        ...
                                        @if($sewas->count() != NULL)
                                          @foreach($sewas as $sewa)
                                            <option value="{{$sewa->id}}" {{ $edit->sewa_id == $sewa->id ? 'selected' : '' }}>{{$sewa->title}}</option>
                                          @endforeach
                                        @endif
                                      </select>
                                  </div>
                          ...
                          <div class="row mb-2">
                              <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                  <div class="form-group">
                                      ...
                                      <input type="number" name="donation" id="donation" class="form-control" value="{{$edit->donation}}" required />
                                  </div>
                              </div>
                              <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                  <div class="form-group">
                                      ...
                                      <select class="form-select" data-control="select2" name="type" id="type" required>
                                        <option value="">Select One</option>
                                        <option value="Esewa" {{ $edit->donationtype == 'Esewa' ? 'selected' : '' }}>Esewa</option>
                                        <option value="QR" {{ $edit->donationtype == 'QR' ? 'selected' : '' }}>QR</option>
                                        <option value="Khalti" {{ $edit->donationtype == 'Khalti' ? 'selected' : '' }}>Khalti</option>
                                        <option value="Nepal Pay" {{ $edit->donationtype == 'Nepal Pay' ? 'selected' : '' }}>Nepal Pay</option>
                                        <option value="Bank Transfer" {{ $edit->donationtype == 'Bank Transfer' ? 'selected' : '' }}>Bank Transfer</option>
                                        <option value="Cheque" {{ $edit->donationtype == 'Cheque' ? 'selected' : '' }}>Cheque</option>
                                        <option value="Cash" {{ $edit->donationtype == 'Cash' ? 'selected' : '' }}>Cash</option>
                                        <option value="Donation Box" {{ $edit->donationtype == 'Donation Box' ? 'selected' : '' }}>Donation Box</option>
                                        <option value="Intl Transfer" {{ $edit->donationtype == 'Intl Transfer' ? 'selected' : '' }}>Intl Transfer</option>
                                        <option value="Other" {{ $edit->donationtype == 'Other' ? 'selected' : '' }}>Other</option>
                                      </select>
                                  </div>
                                </div>
                                <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" data-control="select2" name="status" id="status" required>
                                          ...
                                          <option value="Schedule" {{ $edit->status == 'Schedule' ? 'selected' : '' }}>Schedule</option>
                                          <option value="Refund" {{ $edit->status == 'Refund' ? 'selected' : '' }}>Refund</option>
                                  ...
                                  <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                      <div class="form-group">
                                          ...
                                          <input type="text" name="voucher" id="voucher" value="{{$edit->voucher}}" class="form-control" />
                                      </div>
                                    </div>
                            </div>
                          <div class="row mb-2">
