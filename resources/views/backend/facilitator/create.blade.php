                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body py-4">
                                        ...
                                        <form method="post" action="{{ route('course-facilitator.store') }}"
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-4 col-lg-4 col-sm-4 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            {{-- <input type="text" class="form-control" name="name"
                                                                id="name" value="{{ $edit->name }}" required /> --}}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-lg-4 col-sm-4 mb-2">
                                                        <div class="form-group">
                                                            <label for="course">Course</label>
                                                            <select name="courses[]" id="courses" class="form-select" data-control="select2" multiple required>
                                                                <option value="">Select One</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                                        <button type="submit"
                                                            class="btn btn-primary mb-1 mb-sm-0 mr-0 mr-sm-1">Add
                                                            Course Facilitator</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
