        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Yatra Category Management</h1>
                  ...
                  <div class="card-header border-0 pt-6">
                    <div class="card-toolbar">
                      <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        ...
                        <i class="ki-outline ki-plus fs-2"></i>Add Yatra Category</button>
                      </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form method="post" action="{{ route('yatra-category.store') }}" enctype="multipart/form-data">
                                @csrf
                                  <div class="row">
                                      <div class="col-md-12 col-sm-12 col-lg-12 mb-2">
                                          <div class="form-group">
                                              <label for="catname">Yatra Category Name</label>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{$list->title}}</td>
                            <td>{{$list->slug}}</td>
                            <td>{{$list->createdby}}<br />{{$list->created_at}}</td>
                            <td>@if($list->updatedby != NULL){{$list->updatedby}} @else NA @endif<br />{{$list->updated_at}}</td>
                            <td>
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="{{ route('yatra-category.edit', $list->id)}}" class="btn btn-light d-block">Edit</a>
                                </div>
                                @endcan
                                @can('yatra-delete')
                                <div class="menu-item px-3">
                                  <form action="{{ route('yatra-category.destroy', $list->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
