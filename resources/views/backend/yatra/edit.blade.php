              ...
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card">
                  ...
                  <div class="card-body py-4">
                    ...
                    <form method="post" action="{{ route('yatra.update', $edit->id ) }}" enctype="multipart/form-data">
          						@csrf
          						@method('PATCH')
                      <div class="card-body">
                        <div class="row mb-2">
                          <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                  ...
                                  <select class="form-control" name="devotee" id="devotee" required>
                                    ...
                                    @if($devotees->count() != NULL)
                                      @foreach($devotees as $devotee)
                                        <option value="{{$devotee->id}}" data-kt-rich-content-email="<?php echo $devotee->email; ?>" data-kt-rich-content-mobile="<?php echo $devotee->mobile; ?>" {{ $edit->devotee_id == $devotee->id ? 'selected' : '' }}>{{$devotee->firstname}} {{$devotee->middlename}} {{$devotee->surname}}</option>
                                      @endforeach
                                    @endif
                                  </select>
                              </div>
                            ...
                            <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                <div class="form-group">
                                    <label for="seasons">Yatra Season</label>
                                    <select class="form-select form-select-sm" data-control="select2" name="seasons" id="seasons" required>
                                      <option value="">Select One</option>
                                      @if($seasons->count() != NULL)
                                        @foreach($seasons as $season)
                                          <option value="{{$season->id}}" {{ $edit->yatra_seasons_id == $season->id ? 'selected' : '' }}>{{$season->name}}</option>
                                        @endforeach
                                      @endif
                                    </select>
                                </div>
                              ...
                              <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                  <div class="form-group">
                                      ...
                                      <select class="form-select form-select-sm" data-control="select2" name="status" id="status" required>
                                        ...
                                        <option value="Partial Payment" {{ $edit->status == 'Partial Payment' ? 'selected' : '' }}>Partial Payment</option>
                                        <option value="Hold" {{ $edit->status == 'Hold' ? 'selected' : '' }}>Hold</option>
                            ...
                            <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="contact" id="contact" value="{{ $edit->contact }}">
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                <div class="form-group">
                                   <input type="checkbox" class="form-check-input" name="othertravel" id="othertravel" value="1" {{ $edit->othertravel == 1 ? 'checked' : '' }} />
                                   <label for="othertravel">Other Travel with ISKCON <span class="required"></span></label>
                                </div>
                              </div>
                              <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                <div class="form-group">
                                   <input type="checkbox" class="form-check-input" name="tnc" id="tnc" value="1"  {{ $edit->tnc == 1 ? 'checked' : '' }} required />
