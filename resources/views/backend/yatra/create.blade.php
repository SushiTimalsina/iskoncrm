        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Add Yatra</h1>
                        ...
                        <div class="row mb-2">
                          <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                            ...
                            <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                    ...
                                    <select class="form-select" data-control="select2" name="occupation" id="occupation">
                                      ...
                                      @if($occupations->count() != NULL)
                                        @foreach($occupations as $occupation)
                                          ...
                                          @if(count($occupation->subcategory))
                                            @include('yatra.suboccupation',['subcategories' => $occupation->subcategory])
                                          @endif
                                        @endforeach
                                      @endif
                                    </select>
                              ...
                              <div class="col-md-3 col-sm-3 col-lg-3 mb-4">
                                <div class="form-group">
                                    <label for="childadult">Child/Adult</label>
                                    <select class="form-select" data-control="select2" name="childadult" id="childadult">
                                      <option value="">Select One</option>
                                      @if($childadults->count() != NULL)
                                        @foreach($childadults as $childadult)
                                          <option value="{{$childadult->id}}">{{$childadult->title}}</option>
                                        @endforeach
                                      @endif
                                    </select>
                                </div>
...
$(document).ready(function() {
  ...
  const input = document.createElement("#fromdate");
