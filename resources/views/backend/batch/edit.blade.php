        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Edit Batch</h1>
              ...
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card">
                  ...
                  <div class="card-body py-4">
                    ...
                    <form method="post" action="{{ route('course-batch.update', $edit->id ) }}" enctype="multipart/form-data">
          						@csrf
          						@method('PATCH')
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                    ...
                                    <select name="course" id="course" class="form-select" data-control="select2" required>
                                      ...
                                      @if($courses->count() != NULL)
                                        @foreach($courses as $course)
                                          <option value="{{$course->id}}" {{ $edit->course_id == $course->id ? 'selected' : '' }}>{{$course->title}}</option>
                                        @endforeach
                                      @endif
                                    </select>
                                </div>
                                    ...
                                    <select name="facilitator" id="facilitator" class="form-select" data-control="select2" required>
                                      ...
                                      @if($facilitators->count() != NULL)
                                        @foreach($facilitators as $facilitator)
                                          <option value="{{$facilitator->id}}" {{ $edit->facilitators_id == $facilitator->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="marks" value="{{$edit->fullmarks}}" id="marks" required />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    <label for="fee">Course Fee</label>
                                    <input type="number" class="form-control" name="fee" id="fee" value="{{$edit->fee}}" />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="examtype" name="examtype" required>
                                      <option value="Written" {{ $edit->examtype == 'Written' ? 'selected' : '' }}>Written</option>
                                      <option value="Verbal" {{ $edit->examtype == 'Verbal' ? 'selected' : '' }}>Verbal</option>
                                      <option value="Both" {{ $edit->examtype == 'Both' ? 'selected' : '' }}>Both</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                            ...
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control d-inline-block w-25" value="{{$edit->unit}}" name="unit" id="unit" required />
                                    <select class="form-select d-inline-block w-25" id="unitdays" name="unitdays" required>
                                        <option value="">Unit</option>
                                        <option value="Days" {{ $edit->unitdays == 'Days' ? 'selected' : '' }}>Days</option>
                                        <option value="Weeks" {{ $edit->unitdays == 'Weeks' ? 'selected' : '' }}>Weeks</option>
                                        <option value="Months" {{ $edit->unitdays == 'Months' ? 'selected' : '' }}>Months</option>
                                        <option value="Years" {{ $edit->unitdays == 'Years' ? 'selected' : '' }}>Years</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="start_date" id="start_date" value="{{$edit->start_date}}" />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    <label for="end_date">End Date</label>
                                    <input type="text" class="form-control" name="end_date" id="end_date" value="{{$edit->end_date}}" />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type" required>
                                        <option value="Online" {{ $edit->type == 'Online' ? 'selected' : '' }}>Online</option>
                                        <option value="Physical" {{ $edit->type == 'Physical' ? 'selected' : '' }}>Physical</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                              <div class="form-group">
                                  ...
                                  <input type="hidden" class="custom-file-input" value="{{ $edit->certificate }}" name="identity_old" />
                                  @if ($edit->certificate != '')
                                      <a class="mt-3 d-inline-block ml-2" href="{{ route('certificate.show', ['imageName' => $edit->certificate]) }}" target="_blank"><i class="ki-outline ki-eye fs-3"></i></a>
                                      <div class="mt-2 d-inline-block ms-3">
                                          <input type="checkbox" class="custom-control-input" id="removeid" name="removeid" value="1" />
                                          <label class="custom-control-label" for="removeid">Remove Certificate</label>
                                      </div>
                                  @endif
                              </div>
                            </div>
