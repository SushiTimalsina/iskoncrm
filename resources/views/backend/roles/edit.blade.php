                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="row">
                              ...
                              <div class="col-md-3 col-sm-3 col-lg-3">
                                  <div class="form-group">
                                  <label><input type="checkbox" name="permission[{{$value->id}}]" value="{{$value->id}}" class="name" {{ in_array($value->id, $rolePermissions) ? 'checked' : ''}}> {{Str::title(str_replace('-', ' ', $value->name));}}</label>
                                </div>
                              </div>
                              @endforeach
                            </div>
