        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Course Taken</h1>
              <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                  <a href="{{route('course-taken.index')}}" class="text-muted text-hover-primary">Add Course</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="d-flex flex-column flex-column-fluid">
            <div id="kt_app_content" class="app-content flex-column-fluid">
              <div id="kt_app_content_container" class="app-container container-fluid">
                  <form method="get" action="{{route('coursetakensearch')}}" enctype="multipart/form-data">
                    <div class="card mb-7">
                      <div class="card-body">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2">
                              <label class="fs-6 form-label fw-bold text-gray-900" for="course">Course</label>
                              <select class="form-select" name="course" data-control="select2">
                                <option value="">Select Course</option>
                                @if($courses->count() != NULL)
                                  @foreach($courses as $course)
                                    <option value="{{$course->id}}" @if(isset($_GET['course']) && ($_GET['course'] == $course->id)) selected @endif>{{$course->title}}</option>
                                  @endforeach
                                @endif
                              </select>
                            </div>
                  ...
                  <div class="card-header border-0 pt-6">
                    <div class="card-toolbar">
                      <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        <a href="{{route('course-taken.create')}}" class="btn btn-primary">
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="{{route('course-taken.edit', $list->id)}}" class="btn btn-light d-block">Edit</a>
                                </div>
                                @endcan
                                @can('course-delete')
                                <div class="menu-item px-3">
                                  <form action="{{ route('course-taken.destroy', $list->id)}}" method="post">
                                    @csrf
                                    @method('DELETE')
