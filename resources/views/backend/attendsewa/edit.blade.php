        ...
        <div class="app-header-wrapper d-flex flex-stack w-100">
          ...
          <div id="kt_app_header_page_title_wrapper">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="{default: 'prepend', lg: 'prepend'}" data-kt-swapper-parent="{default: '#kt_app_content_container', lg: '#kt_app_header_page_title_wrapper'}" class="page-title d-flex flex-column justify-content-center me-3 mb-6 mb-lg-0">
              <!--begin::Title-->
              <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center me-3 my-0">Edit Service Attendance</h1>
              ...
              <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card">
                  ...
                  <div class="card-body py-4">
                    ...
                    <form method="post" action="{{ route('sewa-attend.update', $edit->id ) }}" enctype="multipart/form-data">
          						@csrf
          						@method('PATCH')
                      <div class="card-body">
                          ...
                          <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                            ...
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-select form-select-sm form-select-solid" data-control="select2" name="branch" id="branch" required>
                                      <option value="">Select One</option>
                                      ...
                                      <select class="form-select form-select-sm form-select-solid" data-control="select2" name="department" id="department" required>
                                        ...
                                        @if($departments->count() != NULL)
                                          @foreach($departments as $department)
                                            <option value="{{$department->id}}" {{ $edit->department_id == $department->id ? 'selected' : '' }}>{{$department->title}}</option>
                                          @endforeach
                                        @endif
                                      </select>
                                  </div>
                          ...
                          <div class="row mb-2">
                              <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control form-control-solid" name="date" id="date" value="{{$edit->date}}" readonly />
                                  </div>
                              </div>
                              <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                  <div class="form-group">
                                      ...
                                      <select class="form-select form-select-sm form-select-solid" name="designation" id="designation" required>
                                        <option value="Volunteer" {{ $edit->designation == 'Volunteer' ? 'selected' : '' }}>Volunteer</option>
                                        <option value="Head" {{ $edit->designation == 'Head' ? 'selected' : '' }}>Head</option>
                                      </select>
                                  </div>
                              </div>
                            </div>
