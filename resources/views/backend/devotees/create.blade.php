              ...
              <div id="kt_app_content_container" class="app-container container-fluid">
                <div class="card">
                  <div class="card-body pr-5 pl-5">
                    ...
                    <form action="{{ route('posdevoteesearch') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                        <div class="row">
                        <div class="col-md-4 col-sm-4 col-lg-4 mb-3">
                                <div class="form-group">
                                    <label for="firstname">First Name <span class="required"></span></label>
                                    <input type="text" class="form-control" name="firstname" id="firstname" autocomplete="off" value="{{ $devotee->firstname ?? '' }}"  required />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-3">
                                <div class="form-group">
                                    <label for="middlename">Middle Name</label>
                                    <input type="text" class="form-control" name="middlename" id="middlename" autocomplete="off" value="{{ $devotee->middlename ?? '' }}" />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-4 col-lg-4 mb-3">
                                <div class="form-group">
                                    <label for="surname">Surname <span class="required"></span></label>
                                    <input type="text" class="form-control" name="surname" id="surname" autocomplete="off" value="{{ $devotee->surname ?? '' }}" required />
                                </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                              <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                  <div class="form-group">
                                      ...
                                      <input type="email" class="form-control" name="email" id="email" autocomplete="off" value="{{ $devotee->email ?? '' }}" />
                                  </div>
                              ...
                              <div class="col-md-4 col-sm-4 col-lg-4 mb-4">
                                  <div class="form-group">
                                      ...
                                      <input type="number" class="form-control" name="mobile" id="mobile" autocomplete="off" value="{{ $devotee->mobile ?? '' }}" />
                                  </div>
                              <small id="error-message" class="text-danger"></small>
                              </div>
                              <div class="col-md-2 col-sm-2 col-lg-2 mb-2">
                                  <div class="form-group">
                          ...
                          <div class="row">
                            <div class="col-12 d-flex flex-sm-row flex-column mt-2">
                                <button type="submit" class="btn btn-primary d-inline me-5">Next Step</button> <p style="color:#B13126; font-size:16px; line-height: 50px; margin: 0; padding: 0;"><strong>Note: </strong>Please enter either email or mobile is mandatory.</p>
                            </div>
                          </div>
                    </form>
